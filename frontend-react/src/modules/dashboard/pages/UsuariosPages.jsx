      ...
      <div className="flex flex-wrap items-center justify-between gap-4 mb-4">
        ...
        <div className="ml-auto flex items-center gap-2">
          ...
          <button
            ...
            className="px-4 py-2 rounded bg-blue-500 text-white hover:brightness-110 shadow-md transition-all focus:outline-none focus:ring-2 focus:ring-blue-400"
          >
            Ver Cargos
          </button>
        </div>
                ...
                <tr key={usuario.id_usuario}>
                  ...
                  <td className="whitespace-nowrap border border-black p-2">
                    <div className="flex space-x-2">
                      <button className="rounded border border-blue-400 bg-white px-2 py-1 text-blue-500 hover:bg-blue-600 hover:text-white hover:border-blue-600 transition-colors"
